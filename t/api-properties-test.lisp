...
(it-each (("Dia" #x0301) ("Ext" #x30fc) ("GrBase" #x0061) ("Ideo" #x4e00)
    ...
    (property code-point)
  (expect (match (format nil "\\p{~A}" property) (string (code-char code-point)))
          :to-be-truthy))

(it-each (("Dash" #x0041) ("PatSyn" #x0061) ("Term" #x0061)
...
(it
  "matches portable Unicode general-category aliases and their negation"
  (dolist (case '(("L" #x0041 #x0031)
        ("M" #x0301 #x0041)
        ("N" #x0031 #x0041)
        ("P" #x0021 #x0041)
        ("S" #x002B #x0041)
