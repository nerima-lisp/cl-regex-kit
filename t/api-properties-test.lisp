...
(it
  ...
  (dolist (case '(("Dia" #x0301)
                  ...
                  ("XIDS" #x0041)
                  ("XIDC" #x0301)
                  ("ID_Compat_Math_Continue" #x00b2)
                  ("ID_Compat_Math_Start" #x2202)
                  ("InCB" #x0300)
                  ("Indic_Conjunct_Break" #x0300)
                  ("Modifier_Combining_Mark" #x0654)
                  ("MCM" #x0654)
                  ("Other_Alphabetic" #x0345)
                  ("OAlpha" #x0345)
                  ("Other_Default_Ignorable_Code_Point" #x034f)
                  ("ODI" #x034f)
                  ("Other_ID_Continue" #x00b7)
                  ("OIDC" #x00b7)
                  ("Other_ID_Start" #x1885)
                  ("OIDS" #x1885)
                  ("Other_Lowercase" #x00aa)
                  ("OLower" #x00aa)
                  ("Other_Math" #x005e)
                  ("OMath" #x005e)
                  ("Other_Uppercase" #x2160)
                  ("OUpper" #x2160)))
    (destructuring-bind (property code-point) case
      (expect
        (match (format nil "\\p{~A}" property) (string (code-char code-point)))
        :to-be-truthy)))
  (dolist (case '(("Dash" #x0041)
                  ("PatSyn" #x0061)
                  ("Term" #x0061)
                  ("RI" #x1f600)
                  ("EMod" #x1f600)
